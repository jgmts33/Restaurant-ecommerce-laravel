                ...
                <div class="col-lg-12">
                    <div class="row" id="tabs">
                        ...
                        <div style="text-align:center;" class="col-lg-12">
                            ...
                            <br>
                            <a href="/menu"><input style="color:#fff; background-color:greenyellow; font-size:20px;"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="message">
                                    ...
                                    <h4>Emails</h4>
                                    <span><a href="mailto:jorgreemts@gmail.com">jorgreemts@gmail.com</a><br>
                                    </span>
                                </div>
                            </div>
                        </div>
